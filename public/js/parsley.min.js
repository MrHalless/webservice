...
!(function (e, t) {
  ...
  e.extend(E.prototype, y.Field, u.prototype),
    ...
    (A.options = e.extend(o.objectCreate(l), window.ParsleyConfig)),
    (window.ParsleyConfig = A.options),
    (window.Parsley = window.psly = A),
    (window.ParsleyUtils = o);
  var O = (window.Parsley._validatorRegistry = new m(
  ...
  e.extend(!0, A, {
    ...
    addAsyncValidator: function (e, t, i, n) {
      return (
        (A.asyncValidators[e] = { fn: t, url: i || !1, options: n || {} }), this
      );
    },
  }),
    A.addValidator('remote', {
      ...
      validateString: function (t, i, n, r) {
        ...
        (s = e.extend(!0, {}, { url: i, data: o, type: 'GET' }, u)),
          ...
          (a = e.param(s)),
          'undefined' == typeof A._remoteCache && (A._remoteCache = {});
        var d = (A._remoteCache[a] = A._remoteCache[a] || e.ajax(s)),
          h = function () {
