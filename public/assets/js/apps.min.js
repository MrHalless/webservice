...
/////
            $(document).on("hover", "[data-click=panel-fa-plus-circle]", function () {
                $(this).tooltip({
            ...
            }), $(document).on("click", "[data-click=panel-fa-plus-circle]", function (e) {
                e.preventDefault(), $(this).closest(".form-group").next(".form-group").slideToggle()
            }),

            $(document).on("hover", "[data-click=panel-fa-del-circle]", function () {
                $(this).tooltip({
            ...
            }), $(document).on("click", "[data-click=panel-fa-del-circle]", function (e) {
                e.preventDefault(), $(this).closest(".form-group").slideToggle()
            }),

            $(document).on("hover", "[data-click=panel-download]", function () {
                $(this).tooltip({
            ...
            }), $(document).on("click", "[data-click=panel-download]", function (e) {
                //e.preventDefault(), $(this).closest(".form-group").slideToggle()
            }),

            $(document).on("hover", "[data-click=panel-upload]", function () {
                $(this).tooltip({
            ...
            }), $(document).on("click", "[data-click=panel-upload]", function (e) {
                //e.preventDefault(), $(this).closest(".form-group").slideToggle()
            }),
